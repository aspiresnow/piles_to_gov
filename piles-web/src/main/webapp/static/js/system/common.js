...
System.closeAllLoading = function () {
...
layui.config({
    base: '/plugins/module/'
    // base: System.ctxPath + '/assets/common/module/'
}).extend({
    ...
    if (window != top && top.layui && top.layui.index && !top.layui.index.pageTabs) {
        top.layui.admin.activeNav(location.href.substring(System.ctxPath.length));
    }
    ...
    $.ajaxSetup({
        ...
        complete: function (XMLHttpRequest, textStatus) {
            ...
            if (sessionstatus === "timeout") {
                ...
                //如果超时就处理 ，指定要跳转的页面
                window.location = System.ctxPath + "/global/sessionError";
            }
        }
    });
