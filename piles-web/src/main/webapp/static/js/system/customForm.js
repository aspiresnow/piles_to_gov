...
layui.define('layer', function(exports){
  ...
  ,MOD_NAME = 'customForm', ELEM = '.layui-form', THIS = 'layui-this', SHOW = 'layui-show', DISABLED = 'layui-disabled'
  ...
  ,Form = function(){
    this.config = {
      ...
      excludeRenderExpr:".no-form-render"
    };
  };
  ...
  Form.prototype.render = function(type){
    var that = this, items = {
      ...
      ,checkbox: function(){
        ...
        ,checks = $(ELEM).find('input[type=checkbox]').not(that.config.excludeRenderExpr)
      ...
      ,radio: function(){
        ...
        ,radios = $(ELEM).find('input[type=radio]').not(that.config.excludeRenderExpr)
